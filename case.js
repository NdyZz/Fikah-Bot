...
`.trim();
         ...
         default:
            ...
            if (!m?.fromMe & !m?.isGroup) {
               ...
               let caption = `Hᴀʟᴏ @${m?.sender.split('@')[0]} ${ucapanWaktu}, ᴀᴅᴀ ᴀᴘᴀ ᴄʜᴀᴛ *NdyZz*, Jɪᴋᴀ ᴘᴇɴᴛɪɴɢ ᴛɪɴɢɢᴀʟᴋᴀɴ ᴄʜᴀᴛ ᴅᴀɴ *NdyZz* ᴀᴋᴀɴ ᴍᴇᴍʙᴀʟᴀꜱ ꜱᴇᴄᴇᴘᴀᴛ ᴍᴜɴɢᴋɪɴ.`.trim();
               ...
               ptz.sendMessage(m?.chat, { 
                  ...
                  contextInfo: { 
                     ...
                     forwardedNewsletterMessageInfo: {
                        newsletterJid: 'kntl@newsletter',
                        serverMessageId: null,
                        newsletterName: foter3
                     }
                  }
               }, { quoted: { key: { participant: '0@s.whatsapp.net', remoteJid: "0@s.whatsapp.net" }, message: { conversation: foter4}}})
               user.pc = new Date() * 1;
            }
         }
   } catch (err) {
